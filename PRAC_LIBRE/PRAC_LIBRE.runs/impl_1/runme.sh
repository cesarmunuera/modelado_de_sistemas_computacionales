...
HD_PWD='C:/PRACTICA_LIBRE/modelado_de_sistemas_computacionales/PRAC_LIBRE/PRAC_LIBRE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log KYPD_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source KYPD_controller.tcl -notrace
